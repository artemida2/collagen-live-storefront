...
const G = {
  ...
  apple: [asset('/media/p/apple-pear-1.jpg'), asset('/media/p/apple-pear-2.jpg')],
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 2200,
    was: 3000,
    img: asset('/media/p/t-apple-pear.jpg'),
...

  {
    ...
    weight: '2 × 500 г',
    price: 4000,
    img: asset('/media/p/t-set-smuzi.jpg'),
    gallery: G.smuzi,
    juice: 'натуральный сок клубники',
    tone: 'var(--cherry)',
  ...
  },
  {
    ...
    weight: '2 × 500 г',
    price: 4000,
    img: asset('/media/p/t-set-cherry.jpg'),
    gallery: G.cherry,
    juice: 'натуральный сок черешни',
    tone: '#8e1f38',
  ...
  },
  {
    ...
    weight: '2 × 500 г',
    price: 4000,
    img: asset('/media/p/t-set-granat.jpg'),
    gallery: G.granat,
    juice: 'натуральный сок граната',
    tone: 'var(--cherry)',
  ...
  },
  {
    ...
    weight: '2 × 500 г',
    price: 4000,
    img: asset('/media/p/t-set-mango.jpg'),
    gallery: G.mango,
    juice: 'натуральный сок манго и апельсина',
    tone: 'var(--orange)',
  ...
  },
  {
    ...
    weight: '1 кг',
    price: 4000,
    img: asset('/media/p/t-set-vitc-1kg.jpg'),
    gallery: G.vitc,
    tone: 'var(--gold)',
